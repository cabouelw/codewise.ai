  ...
  return (
    <div className="py-20 bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="mb-12">
          <div className="relative h-64 w-full rounded-2xl overflow-hidden mb-8 bg-gradient-to-br from-teal-50 to-purple-50">
            <Image
              src={tool.image}
              alt={tool.name}
              fill
          ...
          <div className="flex items-start gap-6">
            <div className="w-20 h-20 bg-gradient-to-br from-teal-100 to-purple-100 rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 sticky top-24 shadow-lg">
              ...
              <div className="mt-8 space-y-3">
                <Link
                  ...
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-300 text-center block shadow-md hover:shadow-lg"
                >
                  Visit {tool.name} →
                </Link>
                <Link
