...
export const metadata: Metadata = {
  ...
  description: 'Browse 50+ free AI-powered tools for developers. AI code assistants, content generators, translators, image enhancers, and more. Boost your productivity today!',
  keywords: [
    'free AI tools',
  ...
  openGraph: {
    ...
    description: 'Browse 50+ free AI-powered tools: code assistants, content generators, translators & more. Boost your productivity!',
    type: 'website',
