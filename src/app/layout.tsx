...
export const metadata: Metadata = {
	title: {
		default: "CodeWise AI - Hand-Picked AI Tools for Developers",
		template: "%s | CodeWise AI",
	},
	description:
		"Hand-picked, hands-on-tested AI tools for developers. AI code assistants, content generators, translators, and more — reviewed by someone who actually uses them.",
	keywords: [
	...
	openGraph: {
		...
		title: "CodeWise AI - Hand-Picked AI Tools for Developers",
		description:
			"Hand-picked AI tools for developers, reviewed hands-on. Code assistants, content generators, and more.",
		images: [
			{
	...
	twitter: {
		...
		creator: "@codewise_ai",
		title: "CodeWise AI - Hand-Picked AI Tools for Developers",
		description: "Hand-picked, hands-on-tested AI tools for developers.",
